import { MovieSearchResult } from "./movies"
import { PersonSearchResult } from "./people"
import { TvShowSearchResult } from "./tv-shows"
...
export interface MultiSearchResults {
  page: number
  results: Array<
    MultiMovieSearchResult | MultiTvShowSearchResult | MultiPersonSearchResult
  >
  total_pages: number
  total_results: number
}

export const mockMultiSearchResults: MultiSearchResults = {
  page: 1,
  results: [
    {
      adult: false,
    ...
    {
      backdrop_path: "/Ams57f2bNSwWsoQWCfD5u3xQjgS.jpg",
      ...
      popularity: 6.118,
      poster_path: "/dOsASSkNxUjtEp47eSDNazDPDPa.jpg",
      vote_average: 3.5,
      vote_count: 2,
    },
    {
